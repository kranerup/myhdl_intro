   ...
   generate
	 ...
	 for (CCNT=0; CCNT<cols; CCNT=CCNT+1) begin : X
	       REPLACE_MNAME mem (
				  ...
				  // Settings
				  .EMAA(3'b011), .EMAWA(2'b01), .EMASA(1'b0),					    
				  .EMAB(3'b011), .EMAWB(2'b01), .EMASB(1'b0), 
				  .TENA(1'b1), .TCENA(1'b1), .TWENA(1'b1), .TAA({md_w{1'b0}}), .TDA({mw{1'b0}}), 
				  .TENB(1'b1), .TCENB(1'b1), .TWENB(1'b1), .TAB({md_w{1'b0}}), .TDB({mw{1'b0}}), 
				  .DFTRAMBYP(1'b0), .SEA(1'b0), .SEB(1'b0), 
				  .RET1N(1'b1), 
				  .COLLDISN(1'b1)					    
				  );
	 end // block: X
